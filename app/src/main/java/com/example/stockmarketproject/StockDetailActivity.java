...
import com.example.stockmarketsdk.views.StockGraphView;
...
public class StockDetailActivity extends AppCompatActivity {
    ...
    private StockGraphView stockGraphView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stockGraphView = findViewById(R.id.stockGraphView);
            ...
            public void onResponse(Call<BaseResponse<List<StockHistory>>> call, Response<BaseResponse<List<StockHistory>>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getData() != null) {
                    ...
                    if (!historyList.isEmpty()) {
                        stockGraphView.setHistoryData(historyList);
                    } else {
